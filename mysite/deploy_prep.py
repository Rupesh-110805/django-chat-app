...
def main():
    ...
    print("   GOOGLE_OAUTH2_CLIENT_ID=928381654908-n6p7upjh9lslsm1ef0ai5rmgs2qp0kq7.apps.googleusercontent.com")
    print("   GOOGLE_OAUTH2_CLIENT_SECRET=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")
    print("   EMAIL_HOST_USER=rupeshnidadavolu110805@gmail.com")
    print("   EMAIL_HOST_PASSWORD=pnep qqte irjf vtvb")
    print()
